...
public interface XMPMeta extends Cloneable
{
	 ...
	 * @throws com.adobe.xmp.XMPException Wraps all errors and exceptions that may occur.
	 */
	 ...
	 *        constant {@link com.adobe.xmp.XMPConst#ARRAY_LAST_ITEM} always refers to the last existing array
	 *        item.
	 * @return Returns a <code>XMPProperty</code> containing the value and the options or
	 *         <code>null</code> if the property does not exist.
	 * @throws com.adobe.xmp.XMPException Wraps all errors and exceptions that may occur.
	 ...
	 * @throws com.adobe.xmp.XMPException Wraps all errors and exceptions
	 */
	void setProperty(
            String schemaNS,
            String propName,
	 ...
	 * @throws com.adobe.xmp.XMPException Wraps all exceptions that may occur,
	 ...
	 * @param  propName The name of the property
	 * @param  propValue the literal property value as <code>boolean</code>
	 * @throws com.adobe.xmp.XMPException Wraps all exceptions
	 */
	void setPropertyBoolean(
            String schemaNS,
            String propName,
	...
	/**
	 * @see com.adobe.xmp.XMPMeta#setPropertyDate(String, String, com.adobe.xmp.XMPDateTime, com.adobe.xmp.options.PropertyOptions)
	 *  
	 * @param  schemaNS The namespace URI for the property
	 * @param  propName The name of the property
	 * @param  propValue the property value as <code>XMPDateTime</code>
