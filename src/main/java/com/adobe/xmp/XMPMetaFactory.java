...
public final class XMPMetaFactory
{
	 ...
	 * @see com.adobe.xmp.XMPMetaFactory#parse(java.io.InputStream, com.adobe.xmp.options.ParseOptions)
	 * 
	 * @param in an <code>InputStream</code>
	 * @return Returns the <code>XMPMeta</code>-object created from the input.
	 * @throws com.adobe.xmp.XMPException If the file is not well-formed XML or if the parsing fails.
	 */
	...
	/**
	 * Parsing with default options.
	 * @see com.adobe.xmp.XMPMetaFactory#parse(java.io.InputStream)
	 * 
	 ...
	 * @see com.adobe.xmp.XMPMetaFactory#parseFromString(String, com.adobe.xmp.options.ParseOptions)
	 * 
	 * @param packet a String contain an XMP-file.
	...
	/**
	 * Parsing with default options.
	 * @see com.adobe.xmp.XMPMetaFactory#parseFromBuffer(byte[], com.adobe.xmp.options.ParseOptions)
	 * 
	 ...
	 * @throws com.adobe.xmp.XMPException on serializsation errors.
	 */
	 ...
	 * 
	 * @param xmp a metadata object 
	 * @param options Options to control the serialization (see {@link com.adobe.xmp.options.SerializeOptions}).
	 * @param out an <code>OutputStream</code> to write the serialized RDF to.
	 * @throws com.adobe.xmp.XMPException on serializsation errors.
	 */
